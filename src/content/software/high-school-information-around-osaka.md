...
title: "大阪周辺高校情報"
date: "2023-07-13"
excerpt: "大阪の高等学校すべてと、近隣の私立学校の一部の学校のデータを載せてあります。地図、一覧どちらからでも高校の情報（「HP」「住所」「電話番号」）にアクセスできます。絞り込み機能あり、知りたい情報を素早く見つけ出せます。"
image: "/software/high-school-information-around-osaka.webp"
---
...
作成に当たり、[大阪府教育委員会 HP](https://www.pref.osaka.lg.jp/kotogakko/hp/)、[大阪私立中学校高等学校連合会](https://www.osaka-shigaku.gr.jp/school/index.html)のサイトを参考にしました。

### 💻DEMO

| 地図タブ                                                                                                 | リストタブ                                                                                                    |
| -------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- |
| ![地図タブ](https://github.com/drthomas246/OsakaHightSchool/raw/master/public/images/map.png "地図タブ") | ![リストタブ](https://github.com/drthomas246/OsakaHightSchool/raw/master/public/images/list.png "リストタブ") |

| 詳細表示                                                                                                    | フィルター機能                                                                                                          |
| ----------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- |
| ![詳細表示](https://github.com/drthomas246/OsakaHightSchool/raw/master/public/images/detail.png "詳細表示") | ![フィルター機能](https://github.com/drthomas246/OsakaHightSchool/raw/master/public/images/filter.png "フィルター機能") |

### 🌐App URL

- [https://drthomas246.github.io/OsakaHightSchool/](https://drthomas246.github.io/OsakaHightSchool/)
  ![QRコード](https://github.com/drthomas246/OsakaHightSchool/raw/master/public/images/QR.png "QRコード")
...
- ビルドは
  `npm build`
  で dist フォルダーに作成されます。
- 高校データを JSON ファイルで読み込んでいます。JSON データはアプリには扱いやすいですが、人には扱いにくいので、人に扱いやすい CSV データを JSON に変換しています。
  `npm csv2json`
  を実行することで![Node.js](https://img.shields.io/badge/Node.js-gray?logo=nodedotjs&logoColor=%23339933)を使って、hightSchoolData.csv を file.json に変換しています。
...
* README の女の子の絵は[【TRPG 沼】無料立ち絵置き場](https://tachie.trpg-start.com/)からお借りしました。
